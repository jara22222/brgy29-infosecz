...
<body style="font-family: Arial, sans-serif; background-color: #f8fafc; padding: 20px;">
    <div style="max-width: 28rem; margin: 0 auto; background-color: #fff; padding: 32px; border-radius: 8px;">
        <h2 style="color: #0f172a; margin-bottom: 16px;">Your verification code</h2>
        <p style="color: #475569; line-height: 1.5; margin-bottom: 24px;">
            Enter this 6-digit code to continue. It expires in 10 minutes.
        </p>
        ...
        <p style="color: #64748b; font-size: 14px;">If you did not request this code, you can ignore this email.</p>
    </div>
</body>
</html>
